      ...
      <>
        <div className="py-5 bg-gray-100 flex flex-col md:flex-row justify-between items-center px-4 md:px-16 lg:px-32 border">
          ...
          <div className="text-center md:text-left mb-4 md:mb-0">
            <p>
              @2024 Ashis Kumar Mohanty <span>All Rights Reserved</span>
            </p>
          </div>
          {/* Links Section */}
          <div className="space-x-6 md:space-x-5 text-xs md:text-base flex flex-row items-center text-center md:text-right">
